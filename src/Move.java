...
public class Move {
    ...
    public static void moveCalculator(int rowChange, int columnChange) {
        ...
        if (Main.ball[0] == 0 && rowChange == -1) {
            ...
            Main.ball[0] = 0;
        } else if (Main.ball[1] == 0 && columnChange == -1) {
    ...
    public static void moveCalculation(String move) {
        if (move.equals("L")) {
            if (Main.ball[1] == 0) {
                if (Board.boardArray[Main.ball[0]][Board.boardArray[0].length - 1].equals("W")) {
                    moveCalculator(0, 1);
                } else {
                    moveCalculator(0, -1);
                }
            } else if (Board.boardArray[Main.ball[0]][Main.ball[1] - 1].equals("W")) {
                moveCalculator(0, 1);
            } else {
                moveCalculator(0, -1);
            }
        ...
        if (move.equals("R")) {
            if (Main.ball[1] == Board.boardArray[0].length - 1) {
                if (Board.boardArray[Main.ball[0]][0].equals("W")) {
                    moveCalculator(0, -1);
                } else {
                    moveCalculator(0, 1);
                }
        ...
        if (move.equals("U")) {
            if (Main.ball[0] == 0) {
                if (Board.boardArray[Board.boardArray.length - 1][Main.ball[1]].equals("W")) {
                    moveCalculator(1, 0);
                } else {
                    moveCalculator(-1, 0);
                }
            } else if (Board.boardArray[Main.ball[0] - 1][Main.ball[1]].equals("W")) {
                moveCalculator(1, 0);
            } else {
                moveCalculator(-1, 0);
            }
        ...
        if (move.equals("D")) {
            if (Main.ball[0] == Board.boardArray.length - 1) {
                if (Board.boardArray[0][Main.ball[1]].equals("W")) {
                    moveCalculator(-1, 0);
                } else {
                    moveCalculator(1, 0);
                }
